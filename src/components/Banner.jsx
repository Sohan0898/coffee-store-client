const Banner = () => {
  return (
    <div>
      <div className=" bg-cover bg-[url('https://i.ibb.co/7bMJnLR/coffe2.png')]">
              ...
              <div>
                <h1 className="text-4xl font-bold text-white sm:text-6xl lg:text-7xl">
                  ...
                  <div className="relative inline-flex">
                    <span className="absolute inset-x-0 bottom-0 border-b-[30px] border-white"></span>
                    <h1 className="relative text-4xl font-bold text-orange-600 sm:text-6xl lg:text-7xl">
                      Postcrafts.
                    </h1>
                  </div>
                </h1>
